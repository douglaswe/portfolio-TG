...
Durante o projeto, enfrentamos desafios como a saída de um integrante e a demissão de outro, o que reduziu a equipe para quatro pessoas, sendo apenas dois desenvolvedores. Diante disso, precisei assumir também o papel de desenvolvedor frontend, contribuindo diretamente para a criação das telas de informações do cliente, edição do cliente, quadro de clientes e o dashboard, utilizando **React** com **TypeScript** para o desenvolvimento.
